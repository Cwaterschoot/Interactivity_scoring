...
> <img src="https://latex.codecogs.com/gif.latex?MIC_{i}&space;\begin{cases}&space;\frac{(1-log(j(x_{i}))}{i}&space;*&space;(2-w)*&space;(-1)&&space;\text{&space;if&space;}&space;argument(x_{i})=argument(x_{0})&space;\\&space;\frac{(1-log(j(x_{i}))}{i}&space;&&space;\text{&space;if&space;}&space;argument(x_{i})&space;\ne&space;argument(x_{0})&space;\wedge&space;x_i&space;\in&space;Opposition&space;\\&space;\frac{(1-log(j(x_{i}))}{i}&space;*&space;(-1)&space;&&space;\text{&space;if&space;}&space;argument(x_{i})&space;\ne&space;argument(x_{0})&space;\wedge&space;x_i&space;\in&space;Echo&space;\\&space;0&space;&&space;\text{&space;if&space;}&space;i=0&space;\end{cases}" />
